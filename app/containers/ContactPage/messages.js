...
export default defineMessages({
  ...
  scaffoldingHeader: {
    id: 'boilerplate.containers.ContactPage.scaffolding.header',
    defaultMessage: 'Quick scaffolding',
  },
  scaffoldingMessage: {
    id: 'boilerplate.containers.ContactPage.scaffolding.message',
    defaultMessage: `Automate the creation of components, containers, routes, selectors
  and sagas - and their tests - right from the CLI!`,
  },
  feedbackHeader: {
    id: 'boilerplate.containers.ContactPage.feedback.header',
    defaultMessage: 'Instant feedback',
  },
  feedbackMessage: {
    id: 'boilerplate.containers.ContactPage.feedback.message',
    defaultMessage: `
  ...
  stateManagementHeader: {
    id: 'boilerplate.containers.ContactPage.state_management.header',
    defaultMessage: 'Predictable state management',
  },
  stateManagementMessages: {
    id: 'boilerplate.containers.ContactPage.state_management.message',
    defaultMessage: `
  ...
  javascriptHeader: {
    id: 'boilerplate.containers.ContactPage.javascript.header',
    defaultMessage: 'Next generation JavaScript',
  },
  javascriptMessage: {
    id: 'boilerplate.containers.ContactPage.javascript.message',
    defaultMessage: `Use template strings, object destructuring, arrow functions, JSX
    syntax and more, today.`,
  },
  cssHeader: {
    id: 'boilerplate.containers.ContactPage.css.header',
    defaultMessage: 'Contact Us',
  },
  cssMessage: {
    id: 'boilerplate.containers.ContactPage.css.message',
    defaultMessage: 'Next generation CSS',
  },
  routingHeader: {
    id: 'boilerplate.containers.ContactPage.routing.header',
    defaultMessage: 'Industry-standard routing',
  },
  routingMessage: {
    id: 'boilerplate.containers.ContactPage.routing.message',
    defaultMessage: `
  ...
  networkHeader: {
    id: 'boilerplate.containers.ContactPage.network.header',
    defaultMessage: 'Offline-first',
  },
  networkMessage: {
    id: 'boilerplate.containers.ContactPage.network.message',
    defaultMessage: `
  ...
  intlHeader: {
    id: 'boilerplate.containers.ContactPage.internationalization.header',
    defaultMessage: 'Complete i18n Standard Internationalization & Pluralization',
  },
  intlMessage: {
    id: 'boilerplate.containers.ContactPage.internationalization.message',
